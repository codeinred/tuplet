    ...
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dir}")
        ...
        foreach(filename ${all_targets})
            get_filename_component(
                ...
                NAME_WLE)
            note(
                "Adding '${target}' from ${dir}/${target}.cpp with libraries ${library_list}"
            )
...
function(add_test_dir dir)
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dir}")
        ...
        foreach(filename ${all_targets})
            ...
            note(
                "Adding test '${target}' from ${dir}/${target}.cpp with libraries ${library_list}"
            )
            add_executable("${target}" "${filename}")
            target_link_libraries("${target}" PRIVATE ${ARGN})
    ...
    if(CMAKE_CXX_COMPILER_ID
       ...
       "Clang")
        ...
        target_compile_definitions(${target_name}
                                   INTERFACE __cpp_impl_coroutine=1)
    endif()
