...
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v4, single_elem_tuplet_tuple_v4);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v8, single_elem_std_tuple_v8);
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v8, single_elem_tuplet_tuple_v8);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v16, single_elem_std_tuple_v16);
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v16, single_elem_tuplet_tuple_v16);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v32, single_elem_std_tuple_v32);
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v32, single_elem_tuplet_tuple_v32);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v64, single_elem_std_tuple_v64);
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v64, single_elem_tuplet_tuple_v64);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v128, single_elem_std_tuple_v128);
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v128, single_elem_tuplet_tuple_v128);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v256, single_elem_std_tuple_v256);
BENCHMARK_CAPTURE(BM_copy, single_elem_tuplet_tuple_v256, single_elem_tuplet_tuple_v256);
BENCHMARK_CAPTURE(BM_copy, single_elem_std_tuple_v512, single_elem_std_tuple_v512);
